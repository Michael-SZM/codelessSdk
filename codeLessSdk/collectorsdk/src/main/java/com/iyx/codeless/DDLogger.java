...
public class DDLogger {
    ...
    public static void v(String tag, String message, Object... args) {
        ...
        if (args == null || args.length == 0) {
            Log.v(tag, nullToEmpty(message));
            return;
        }

        Log.v(tag, String.format(nullToEmpty(message), args));
    }
    ...
    public static void d(String tag, String message, Object... args) {
        ...
        if (args == null || args.length == 0) {
            Log.d(tag, nullToEmpty(message));
            return;
        }

        Log.d(tag, String.format(nullToEmpty(message), args));
    }
    ...
    public static void i(String tag, String message, Object... args) {
        ...
        if (args == null || args.length == 0) {
            Log.i(tag, nullToEmpty(message));
            return;
        }

        Log.i(tag, String.format(nullToEmpty(message), args));
    }
    ...
    public static void w(String tag, String message, Object... args) {
        ...
        if (args == null || args.length == 0) {
            Log.w(tag, nullToEmpty(message));
            return;
        }


        Log.w(tag, String.format(nullToEmpty(message), args));
    }
    ...
    public static void e(String tag, String message, Object... args) {
        ...
        Log.e(tag, String.format(nullToEmpty(message), args));
    }
